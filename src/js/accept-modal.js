...
export const openAcceptModal = e => {
    ...
    switch (e.target.dataset.modal) {
        case 'change-username':
            ...
            reauthBox.classList.add('unshown');
            title.textContent = 'Change username';
            refs.acceptValueTitle.classList.add('hidden');
        ...
        case 'change-email':
            ...
            reauthBox.classList.remove('unshown');
            refs.acceptValueTitle.classList.remove('hidden');
            refs.acceptValueTitle.textContent = 'Change your email';
        ...
        case 'change-password':
            ...
            reauthBox.classList.remove('unshown');
            refs.acceptValueTitle.classList.remove('hidden');
            refs.acceptValueTitle.textContent = 'Change your password';
