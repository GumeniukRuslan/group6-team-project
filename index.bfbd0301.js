 ...
 * limitations under the License.
 */
function ct(t,e=[]){let n;switch(t){case"Browser":n=Y((0,i.getUA)());break;case"Worker":n=`${Y((0,i.getUA)())}-${t}`;break;default:n=t}const o=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${r.SDK_VERSION}/${o}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new I(5e3,15e3),Qe={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Je=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ye(t){const e=t.config;v(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?T(e,"emulator/auth/iframe"):`https://${t.config.authDomain}/__/auth/iframe`,o={apiKey:e.apiKey,appName:t.name,v:r.SDK_VERSION},s=Je.get(t.config.apiHost);s&&(o.eid=s);const a=t._getFrameworks();return a.length&&(o.fw=a.join(",")),`${n}?${(0,i.querystring)(o).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(){this._=void 0}}function Ye(t,e,n){return t instanceof en?nn(t,e):t instanceof rn?on(t,e):n}function Ze(t,e){var n,i;return t instanceof sn?Ot(n=e)||(i=n)&&"doubleValue"in i?e:{integerValue:0}:null}class tn extends Je{}class en extends Je{constructor(t){super(),this.elements=t}}function nn(t,e){const n=cn(e);for(const e of t.elements)n.some((t=>St(t,e)))||n.push(e);return{arrayValue:{values:n}}}class rn extends Je{constructor(t){super(),this.elements=t}}function on(t,e){let n=cn(e);for(const e of t.elements)n=n.filter((t=>!St(t,e)));return{arrayValue:{values:n}}}class sn extends Je{constructor(t,e){super(),this.serializer=t,this.gt=e}}function an(t){return bt(t.integerValue||t.doubleValue)}function cn(t){return Mt(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bi{constructor(t){this.serializer=t,this.cs=new Map,this.hs=new Map}getBundleMetadata(t,e){return J.resolve(this.cs.get(e))}saveBundleMetadata(t,e){var n;return this.cs.set(e.id,{id:(n=e).id,version:n.version,createTime:oi(n.createTime)}),J.resolve()}getNamedQuery(t,e){return J.resolve(this.hs.get(e))}saveNamedQuery(t,e){return this.hs.set(e.name,{name:(n=e).name,query:Ai(n.bundledQuery),readTime:oi(n.readTime)}),J.resolve();var n}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ui{constructor(){this.overlays=new lt(V.comparator),this.ls=new Map}getOverlay(t,e){return J.resolve(this.overlays.get(e))}getOverlays(t,e){const n=ze();return J.forEach(e,(e=>this.getOverlay(t,e).next((t=>{null!==t&&n.set(e,t)})))).next((()=>n))}saveOverlays(t,e,n){return n.forEach(((n,i)=>{this.we(t,e,i)})),J.resolve()}removeOverlaysForBatchId(t,e,n){const i=this.ls.get(n);return void 0!==i&&(i.forEach((t=>this.overlays=this.overlays.remove(t))),this.ls.delete(n)),J.resolve()}getOverlaysForCollection(t,e,n){const i=ze(),r=e.length+1,o=new V(e.child("")),s=this.overlays.getIteratorFrom(o);for(;s.hasNext();){const t=s.getNext().value,o=t.getKey();if(!e.isPrefixOf(o.path))break;o.path.length===r&&t.largestBatchId>n&&i.set(t.getKey(),t)}return J.resolve(i)}getOverlaysForCollectionGroup(t,e,n,i){let r=new lt(((t,e)=>t-e));const o=this.overlays.getIterator();for(;o.hasNext();){const t=o.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=r.get(t.largestBatchId);null===e&&(e=ze(),r=r.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}const s=ze(),a=r.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach(((t,e)=>s.set(t,e))),!(s.size()>=i)););return J.resolve(s)}we(t,e,n){const i=this.overlays.get(n.key);if(null!==i){const t=this.ls.get(i.largestBatchId).delete(n.key);this.ls.set(i.largestBatchId,t)}this.overlays=this.overlays.insert(n.key,new Sn(e,n));let r=this.ls.get(e);void 0===r&&(r=qe(),this.ls.set(e,r)),this.ls.set(e,r.add(n.key))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
