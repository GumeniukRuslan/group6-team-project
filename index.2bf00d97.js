 ...
 * limitations under the License.
 */
async function It(t,e){return O(t,"POST","/v1/accounts:signInWithPassword",_(t,e))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const We=new T(3e4,6e4);function He(){const t=ae().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let qe=null;function $e(t){return qe=qe||function(t){return new Promise(((e,n)=>{var i,r,s;function o(){He(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{He(),n(m(t,"network-request-failed"))},timeout:We.get()})}if(null===(r=null===(i=ae().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=ae().gapi)||void 0===s?void 0:s.load)){const e=dt("iframefcb");return ae()[e]=()=>{gapi.load?o():n(m(t,"network-request-failed"))},ft(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw qe=null,t}))}(t),qe}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=new lt(V.comparator);function Me(){return Pe}const Fe=new lt(V.comparator);function Ue(...t){let e=Fe;for(const n of t)e=e.insert(n.key,n);return e}function Be(t){let e=Fe;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function je(){return Ve()}function ze(){return Ve()}function Ve(){return new Le((t=>t.toString()),((t,e)=>t.isEqual(e)))}const We=new lt(V.comparator),He=new ft(V.comparator);function qe(...t){let e=He;for(const n of t)e=e.add(n);return e}const $e=new ft(L);function Ke(){return $e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(t,e,n,i,r){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=r}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const i=new Map;return i.set(t,Vn.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new zn(F.min(),i,new lt(L),Me(),qe())}}class Vn{constructor(t,e,n,i,r){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=r}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new Vn(n,e,qe(),qe(),qe())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xi{constructor(){this.qi=!1}initialize(t,e){this.Ui=t,this.indexManager=e,this.qi=!0}getDocumentsMatchingQuery(t,e,n,i){return this.Ki(t,e).next((r=>r||this.Gi(t,e,i,n))).next((n=>n||this.Qi(t,e)))}Ki(t,e){if(be(e))return J.resolve(null);let n=Ie(e);return this.indexManager.getIndexType(t,n).next((i=>0===i?null:(null!==e.limit&&1===i&&(e=Se(e,null,"F"),n=Ie(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next((i=>{const r=qe(...i);return this.Ui.getDocuments(t,r).next((i=>this.indexManager.getMinOffset(t,n).next((n=>{const s=this.ji(e,i);return this.zi(e,s,r,n.readTime)?this.Ki(t,Se(e,null,"F")):this.Wi(t,s,e,n)}))))})))))}Gi(t,e,n,i){return be(e)||i.isEqual(F.min())?this.Qi(t,e):this.Ui.getDocuments(t,n).next((r=>{const s=this.ji(e,r);return this.zi(e,s,n,i)?this.Qi(t,e):(d()<=o.LogLevel.DEBUG&&p("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),_e(e)),this.Wi(t,s,e,H(i,-1)))}))}ji(t,e){let n=new ft(Oe(t));return e.forEach(((e,i)=>{Ae(t,i)&&(n=n.add(i))})),n}zi(t,e,n,i){if(null===t.limit)return!1;if(n.size!==e.size)return!0;const r="F"===t.limitType?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Qi(t,e){return d()<=o.LogLevel.DEBUG&&p("QueryEngine","Using full collection scan to execute query:",_e(e)),this.Ui.getDocumentsMatchingQuery(t,e,$.min())}Wi(t,e,n,i){return this.Ui.getDocumentsMatchingQuery(t,n,i).next((t=>(e.forEach((e=>{t=t.insert(e.key,e)})),t)))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
